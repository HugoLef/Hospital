...
public class graph extends JFrame implements ActionListener {
	...
	private JLabel tabl;
	private String chx, colo1, colo2, colo3, colo4, colo5, colo6;
...
//***********************************************DebutAjout********************************************************
	...
	public void ajout(String tableau) {
		...
		case "Chambre":
			...
			soummettre.setBounds(150, 160, 120, 30);
		...
		case "Docteur":
			...
			col1.setBounds(100, 10, 300, 20);
			col2.setBounds(100, 50, 300, 20);
			soummettre.setBounds(150, 80, 120, 30);
		...
		case "Employe":
			...
			soummettre.setBounds(150, 200, 120, 30);
		...
		case "Malade":
			...
			soummettre.setBounds(150, 240, 120, 30);
	...
	public void verifie(boolean verif) {
		...
		if(verif == true) {
			pan.setLayout(null);
			txt = new JLabel("operation réussie");
			txt.setBounds(300, 20, 100, 30);
		}
		else {
			pan.setLayout(null);
			txt = new JLabel("Erreur");
			txt.setBounds(300, 20, 100, 30);
		}
	}
